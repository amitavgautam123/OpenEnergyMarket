...
boolean revertDeletionBtnDisplayStatus = isElementPresent(revertMeterDeletionBtn(meterNum));
			...
			String capacity) throws Throwable
	{
		...
		Reporter.log("Added test data in variius fields.", true);
		...
		Reporter.log("Checked if error message is displaying in the mandatory fields.", true);
		if(getAttribute(this.capacity, "value").equals("")) {
			...
			Reporter.log("Checked if error message is displaying in the capacity field.", true);
