...
public class JyperionListener implements ITestListener {
    ...
    public void onTestFailure(ITestResult result) {
        ...
        if (this.failTable == null) {
            this.failTable = new PdfPTable(new float[]{.8f, .3f, .1f, .3f});
        ...
        if (throwable != null) {
            ...
            Chunk imdb = new Chunk("[SCREEN SHOT]", new Font(Font.FontFamily.TIMES_ROMAN, Font.DEFAULTSIZE, Font.UNDERLINE));
