...
import com.oem.framework.pages.FlexibleProfileAdminPage;
...
public class FlexibleProfileAdminTest extends BaseTest{
	...
	public void TC_FMP_03() throws Throwable{
		...
		AdminDashboardPage admindashborad=(AdminDashboardPage) loginPage.loginAsAdmin();
		Thread.sleep(5000);
		FlexibleProfileAdminPage flexibleprofileAdmin= (FlexibleProfileAdminPage)admindashborad.goToflexProcurementAdmin();
		Thread.sleep(5000);
