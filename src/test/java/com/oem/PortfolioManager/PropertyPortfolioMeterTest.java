...
public class PropertyPortfolioMeterTest extends BaseTest {
    ...
    public void beforeMeterPage() throws Throwable {
	  ...
	  public void PM_PP_TC_015_validateAddHHMeterPopupTest() throws Throwable { 
		  customerDashboardPage.
		  		goToPropertyPortfolioMeterPage().validateAddHHMeterPopup(); 
	  }
	  ...
	  @Test(dataProvider = "getHHdata")
		...
		public void PM_PP_TC_026_addHHMeterUsingValidTestDataTest() throws Throwable {
			...
			CustomerDashboardPage customerDashboardPage = (CustomerDashboardPage) loginPage
					.login();
			PropertyPortfolioMeterPage propertyPortfolioMeterTest = (PropertyPortfolioMeterPage) customerDashboardPage.goToPropertyPortfolioMeterPage();
			propertyPortfolioMeterTest.addingHHMeterCheckMeterCountEditDeleteReviewOptionTest();
		}
		@Test
	...
	public void PM_PP_TC_028_checkSavedDetailsAfterAddingHHmeterTest() throws Throwable {
		LoginPage loginPage = new LoginPage();
		CustomerDashboardPage customerDashboardPage = (CustomerDashboardPage) loginPage.login();
		PropertyPortfolioMeterPage propertyPortfolioMeterTest = (PropertyPortfolioMeterPage) customerDashboardPage
	...
	public void validateHHcontractHistoryMandatoryFieldUsingDataProviderTest(String dayRate, String nightRate,
		...
		PropertyPortfolioMeterPage propertyPortfolioMeterTest = (PropertyPortfolioMeterPage) customerDashboardPage
				.goToPropertyPortfolioMeterPage();
		propertyPortfolioMeterTest.validateMandatoryFieldsContractHistoryPopupDataProvider(dayRate, nightRate,
	...
	public void validateMandatoryFieldHHcontHistUsingDataProviderTest2(int day, int month, int year, String dayRate,
		...
		PropertyPortfolioMeterPage propertyPortfolioMeterTest = (PropertyPortfolioMeterPage) customerDashboardPage
				.goToPropertyPortfolioMeterPage();
		propertyPortfolioMeterTest.validateMandatoryFieldsContractHistoryPopupDataProvider2(day, month, year, dayRate,
	...
	public void validateMandatoryFieldHHcontHistUsingDataProviderTest3(int day, int month, int year, String dayRate,
		...
		PropertyPortfolioMeterPage propertyPortfolioMeterTest = (PropertyPortfolioMeterPage) customerDashboardPage
				.goToPropertyPortfolioMeterPage();
		propertyPortfolioMeterTest.validateMandatoryFieldsContractHistoryPopupDataProvider3(day, month, year, dayRate,
				nightRate, standingCharge, capacityCharge, contractedAnnualSpend);
	}
	...
	public void validateMandatoryFieldsNHHmeterUsingDataProviderTest(String meterNoDropdownFieldValue,
		...
		PropertyPortfolioMeterPage propertyPortfolioMeterTest = (PropertyPortfolioMeterPage) customerDashboardPage
				.goToPropertyPortfolioMeterPage();
		propertyPortfolioMeterTest.validateAddnHHMeterPopupUsingDifferentTestData(meterNoDropdownFieldValue,
